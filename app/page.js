...
export default function Home() {
  ...
  const features = [
    {
      ...
      description:
        "Advanced machine learning algorithms detect dental issues with high accuracy",
    },
    {
      icon: "⚡",
    ...
    },
    {
      ...
      description:
        "Receive detailed insights with symptoms and recommendations",
    },
    {
      icon: "🛡️",
      title: "Privacy First",
      description:
        "Your data is secure and processed with complete confidentiality",
    },
  ];
  ...
  const steps = [
    ...
    },
    {
      ...
      title: "AI Analysis",
      description:
        "Our advanced AI processes the image to detect potential issues",
      icon: "🔍",
    },
    {
      number: "3",
      title: "Get Results",
      description:
        "Receive detailed report with observations and recommendations",
      icon: "📋",
    },
  ];
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-5xl sm:text-6xl font-bold text-gray-900 mb-6">
            ...
            <span className="text-indigo-600">Oral Health</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Get instant AI-powered analysis of your dental health. Upload a
            photo and receive comprehensive insights in seconds.
          </p>
              ...
              <div className="flex flex-col items-center">
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-gray-500 text-sm hidden xl:block">
      ...
      <section className="py-16 bg-indigo-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-indigo-100 mb-8">
            Join thousands of users who trust DentAI for their dental health
            monitoring
          </p>
          <button
            onClick={() =>
